...
class SurveySurvey(models.Model):
    ...
    survey_type = fields.Selection(selection_add=[('lead_qualification', 'Lead qualification')], ondelete={'lead_qualification': 'set default'})
    ...
    def _compute_allowed_survey_types(self):
        ...
        self.allowed_survey_types = (self.allowed_survey_types or []) + ['lead_qualification']
        for record in self:
    ...
    def action_survey_user_input_completed(self):
        ...
        if self.survey_type == 'lead_qualification':
            action.update({
                'domain': [('survey_id.survey_type', '=', 'lead_qualification')]
            })
        return action
