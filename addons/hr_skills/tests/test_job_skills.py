...
@tagged("recruitment")
class TestJobSkills(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_employee_with_no_certifications_gets_activity(self):
        ...
        """
        activities = self.t_job._add_certification_activity_to_employees()
    ...
    def test_activities_are_only_created_once(self):
        ...
        new_activities = self.t_job._add_certification_activity_to_employees()
