...
test("operator can send conversation after livechat ends", async () => {
    ...
    await press("Enter");
    await contains(".o_notification_manager", { text: "Conversation sent to abc@example.com" });
    await contains(".o-mail-NotificationMessage", { text: "Mitchell Admin sent the conversation to abc@example.com10:30 AM" });
});
