...
class AccountMove(models.Model):
    ...
    def get_extra_print_items(self):
        ...
        if self.l10n_it_edi_attachment_file:
            print_items.append({
    ...
    def _l10n_it_edi_process_downloads(self, invoices_data, proxy_user):
        ...
        for move in moves:
            move._extend_with_attachments(attachments.filtered(lambda a: a.res_id == move.id), new=True)
            if not modules.module.current_test:
                self.env.cr.commit()
    ...
    def _l10n_it_edi_transform_notification(self, parsed_notification):
        ...
        if not filename and self.l10n_it_edi_attachment_file:
            filename = self.l10n_it_edi_attachment_name
