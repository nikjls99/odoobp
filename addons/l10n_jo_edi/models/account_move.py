...
class AccountMove(models.Model):
    ...
    def _l10n_jo_validate_config(self):
        ...
        if error_msg:
            return _("%s To set: Configuration > Settings > Electronic Invoicing (Jordan)\n", error_msg)
    ...
    def _l10n_jo_validate_fields(self):
        ...
        if self.move_type == 'out_refund':
            if not self.reversed_entry_id:
                ...
                error_msg += _("Please make sure the currency of the credit note is the same as the related invoice\n")
