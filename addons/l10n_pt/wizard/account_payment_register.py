...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _compute_l10n_pt_at_series_id(self):
        for wizard in self:
            series_ids = wizard.available_l10n_pt_at_series_ids
            if not series_ids:
            ...
            last_payment = self.env['account.payment'].search([
                ...
                ('l10n_pt_at_series_id', 'in', wizard.available_l10n_pt_at_series_ids.ids),
            ], order='id desc', limit=1)

            wizard.l10n_pt_at_series_id = last_payment.l10n_pt_at_series_id or series_ids[0]._origin
