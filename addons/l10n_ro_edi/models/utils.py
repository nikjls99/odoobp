...
def _request_ciusro_synchronize_invoices(company, session, nb_days=1):
    ...
    where `dict` is {'data_creare': `str`, 'cif': `str`, 'id_solicitare': `str`, 'detalii': `str`,
    'tip': 'FACTURA TRIMISA'|'ERORI FACTURA'|'FACTURA PRIMITA', 'id': `str`, answer: <`_request_ciusro_download_answer`>}; representing a message.
