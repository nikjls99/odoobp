...
class AccountEdiFormat(models.Model):
    ...
    def _check_move_configuration(self, invoice):
        ...
        if invoice.l10n_sa_show_reason and not invoice._l10n_sa_check_refund_reason():
            errors.append(
                _("- Please make sure the 'ZATCA Reason' for the issuance of the Credit/Debit Note is specified."))
        if invoice.l10n_sa_show_reason and not invoice.ref:
            errors.append(
                _("- Please make sure the 'Customer Reference' contains the sequential number of the original invoice(s) that the Credit/Debit Note is related to."))
        return errors
