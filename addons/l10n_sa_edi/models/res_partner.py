...
class ResPartner(models.Model):
    ...
    l10n_sa_edi_additional_identification_scheme = fields.Selection([
        ...
        ('PAS', 'Passport ID'),
        ('OTH', 'Other ID')
    ], default="OTH", string="ZATCA Identification Scheme", help="Additional Identification Scheme for the Seller/Buyer")

    l10n_sa_edi_additional_identification_number = fields.Char("ZATCA Identification Number (SA)", help="Additional Identification Number for the Seller/Buyer")
