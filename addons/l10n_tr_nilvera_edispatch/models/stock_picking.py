...
class StockPicking(models.Model):
    ...
    l10n_tr_nilvera_dispatch_scenario = fields.Selection(
        ...
        help="Used to populate the category of the dispatch.",
    ...
    l10n_tr_nilvera_buyer_id = fields.Many2one(
        string="Buyer",
        help="Used for the original party who purchases the good when the Dellivery Address is for another recipient",
        comodel_name='res.partner'
    )
    ...
    l10n_tr_vehicle_plate = fields.Char(string="Vehicle Plate", help="Used to input the plate number of the truck.")
