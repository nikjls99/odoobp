...
export class ChatWindow extends Component {
    ...
    async close(options) {
        ...
        const isCurrentStateOurs =
            this.chatWindowHistoryState &&
            browser.history.state?.chatWindowOpen === this.chatWindowHistoryState.chatWindowOpen;
    ...
    handlePopstate(event) {
        if (this.ui.isSmall) {
            const navigatedAwayFromOurState =
                event.state?.chatWindowOpen !== this.chatWindowHistoryState.chatWindowOpen;
