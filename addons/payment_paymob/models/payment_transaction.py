...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        api_url = f'''{paymob_url}/unifiedcheckout/?publicKey={
            payment_utils.normalize_text(self.provider_id.paymob_public_key)
    ...
    def _paymob_prepare_payment_request_payload(self):
        ...
        # Oman Net Integrations should be passed in the Intention API. Transaction will fail if you
        # will only pass Oman Net Integration ID.
    ...
    def _compare_notification_data(self, notification_data):
        ...
        amount = amount_cents / const.PAYMOB_CONFIG[self.currency_id.name]['amount_cents']
