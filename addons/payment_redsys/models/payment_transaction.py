...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        return {
            ...
            'signature_version': self.provider_id.signature_version,
    ...
    def _prepare_merchant_parameters(self):
        ...
        webhook_url = urls.url_join(base_url, RedsysController._webhook_url)
        return_url = urls.url_join(base_url, RedsysController._return_url)
        payment_method = const.PAYMENT_METHODS_MAPPING.get(self.payment_method_id.code, 'C')
