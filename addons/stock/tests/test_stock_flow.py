...
class TestStockFlowPostInstall(TestStockCommon):
    ...
    def test_picking_and_move_scheduled_date_flow(self):
        ...
        1. Changing a move date to after the scheduled date should not affect the scheduled date or other move dates.
        2. Changing a move date to before the scheduled date should update the scheduled date to match the
        earliest move date, but should not affect other move dates.
