...
export class Many2XAutocomplete extends Component {
    ...
    setup() {
        ...
        this.openMany2X =
            ...
            useOpenMany2XRecord({
                ...
                component: this.constructor.components.CreateDialog,
            });
    ...
    async suggest(request, lock) {
        ...
        if (request.length < this.props.searchThreshold) {
            if (this.addStartTypingSuggestion(request)) {
                suggestions.push(this.buildStartTypingSuggestion(request));
            }
        } else {
            ...
            } else if (this.addNoRecordsSuggestion(request)) {
                suggestions.push(this.buildNoRecordsSuggestion(request));
            }
        }
    ...
    addCreateSuggestion({ request, records }) {
    ...
    addNoRecordsSuggestion(request) {
    ...
    addStartTypingSuggestion(request) {
    ...
    buildNoRecordsSuggestion(request) {
        return {
    ...
    buildStartTypingSuggestion(request) {
        return {
