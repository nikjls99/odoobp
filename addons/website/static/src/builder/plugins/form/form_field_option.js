...
import { getDependencyEl, getFieldName, getMultipleInputs, isFieldCustom, getCurrentFieldInputEl } from "./utils";
...
export class FormFieldOption extends BaseOptionComponent {
    ...
    get isTextConditionValueVisible_require() {
        const el = this.env.getEditingElement();
        const currentFieldInputEl = getCurrentFieldInputEl(el);
        return (
            el.dataset.requirementComparator && !currentFieldInputEl.classList.contains("datetimepicker-input") &&
